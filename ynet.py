...
def scrape_ynet():
    site_name = "ynet"
    site_home = "https://www.ynet.co.il/entertainment/article/b1i8nl111k"
    site_proof = "ynet.co"
    path_scrape_list = ".\\Websites\\Ynet\\ynet_category_list.txt"
    path_already_scraped = ".\\Websites\\Ynet\\ynet_articles_organized.txt"
    path_write_articles = ".\\Websites\\Ynet\\ynet_articles_raw.txt"
